...
write.csv(resdata, file = paste0("edgeR-diffexpr-results_", comp, ".csv"))
...
write.csv(fpkm, file = paste0("edgeR_FPKM_", comp, ".csv"))
write.csv(cpm(dgList, log = TRUE), file = paste0("edgeR_log2CPM_", comp, ".csv"))
